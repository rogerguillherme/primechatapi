...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`[OUTBOUND] account_id=${account_id} phone_number_id=${phoneNumberId} waba_id=${businessAccountId} token_fp=${tokenFp} provider=${isD360 ? "d360" : "meta_cloud"} api=${apiUrl}`);
