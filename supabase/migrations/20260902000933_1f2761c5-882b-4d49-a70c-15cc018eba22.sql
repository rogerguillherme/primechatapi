...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.metrics_tiers TO authenticated;
GRANT ALL ON public.metrics_tiers TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.metrics_goals TO authenticated;
GRANT ALL ON public.metrics_goals TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.metrics_seasons TO authenticated;
GRANT ALL ON public.metrics_seasons TO service_role;
