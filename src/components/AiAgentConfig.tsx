...
import { Bot, User, FileText, HelpCircle, FolderOpen, Save, Volume2, Plus, Trash2, Upload, ArrowLeft, ChevronRight, Play, Pause, Zap, GraduationCap, MessageSquare, Send, Loader2, ThumbsDown, RefreshCw } from "lucide-react";
